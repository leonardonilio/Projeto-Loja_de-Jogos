INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (1, 	"Assassin's Creed Brotherhood", 	"Ubisoft Montreal", 		"assassin's creed brotherhood - capa1.png", 	59.99,		8.9, 		"ACB desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (2, 	"Borderlands2", 					"Gearnox Software", 		"borderlands 2 - capa1.png", 					44.99,		10, 		"BL2 desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (3,	"Counter-Strike 2",					"Valve",					"counter-strike 2 - capa1.png",					0,			8.7,		"CS2 desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (4,	"Disco Elysium",					"ZA/UM",					"Disco Elysium - capa1.png",					75.49,		10,			"DE desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (5,	"Elden Ring",						"FromSoftware",				"elden ring - capa1.png",						274.50,		9.5,		"ELR desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (6,	"Fallout: New Vegas",				"Obsidian Entertainment",	"fallout new vegas - capa1.png",				39,			9.7,		"FNV desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (7,	"Garry's Mod",						"Facepunch Studios",		"garry's mod - capa1.png",						25.99,		9,			"GM desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (8,	"Hollow Knight",					"Team Cherry",				"hollow knight - capa1.png",					46.99,		10,			"HLK desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (9,	"Inscryption",						"Daniel Mullins Games",		"inscryption - capa1.png",						49.99,		8.7,		"INC desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (10,	"Journey",							"thatgamecompany",			"journey - capa1.png",							43.99,		8.8,		"JRN desc");
