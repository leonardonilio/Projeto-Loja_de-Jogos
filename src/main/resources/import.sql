INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (1, 	"Assassin's Creed Brotherhood", 	"Ubisoft Montreal", 		"/resources/imagem/capa/assassins_creed_brotherhood_capa1.png", 	59.99,		8.9, 		"ACB desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (2, 	"Borderlands2", 					"Gearnox Software", 		"/resources/imagem/capa/borderlands2_capa1.png", 					44.99,		10, 		"BL2 desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (3,	"Counter-Strike 2",					"Valve",					"/resources/imagem/capa/counter-strike_2_capa1.png",				0,			8.7,		"CS2 desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (4,	"Disco Elysium",					"ZA/UM",					"/resources/imagem/capa/disco_elysium_capa1.png",					75.49,		10,			"DE desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (5,	"Elden Ring",						"FromSoftware",				"/resources/imagem/capa/elden_ring_capa1.png",					274.50,		9.5,		"ELR desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (6,	"Fallout: New Vegas",				"Obsidian Entertainment",	"/resources/imagem/capa/fallout_new_vegas_capa1.png",				39,			9.7,		"FNV desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (7,	"Garry's Mod",						"Facepunch Studios",		"/resources/imagem/capa/garry's_mod_capa1.png",					25.99,		9,			"GM desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (8,	"Hollow Knight",					"Team Cherry",				"/resources/imagem/capa/hollow_knight_capa1.png",					46.99,		10,			"HLK desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (9,	"Inscryption",						"Daniel Mullins Games",		"/resources/imagem/capa/inscryption_capa1.png",					49.99,		8.7,		"INC desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, nota, detalhes) VALUE (10,	"Journey",							"thatgamecompany",			"/resources/imagem/capa/journey_capa1.png",						43.99,		8.8,		"JRN desc");
