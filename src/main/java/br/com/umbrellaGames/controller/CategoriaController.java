...
public class CategoriaController {
	...
	@GetMapping("/id/{id}")
	public Categoria buscarPorCategoria(@PathVariable int id) {
		Categoria categoria = categoriaService.buscarPorId(id);
		return categoria;
	}
	
	@GetMapping("/nome_categoria/{nome_categoria}")
	public Categoria buscarPorNome(@PathVariable String nome_categoria) {
		Categoria categoria = categoriaService.buscarPorNome(nome_categoria);
		return categoria;
	}
	
	@GetMapping("/primeiro_nome_categoria/{nome_categoria}")
	...
	@GetMapping("/ultimo_nome_categoria/{nome_categoria}")
	...
	@GetMapping("/letra_do_nome_categoria/{nome_categoria}")
