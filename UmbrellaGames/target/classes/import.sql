INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (1, 	"Assassin's Creed Brotherhood", 	"Ubisoft Montreal", 		"/resources/imagem/capa/assassin's creed brotherhood - capa1.png", 	59.99, 		"ACB desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (2, 	"Borderlands2", 			"Gearnox Software", 		"/resources/imagem/capa/borderlands2 - capa1.png", 			44.99, 		"BL2 desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (3,	"Counter-Strike 2",			"Valve",			"/resources/imagem/capa/counter-strike 2 - capa1.png",			0,		"CS2 desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (4,	"Disco Elysium",			"ZA/UM",			"/resources/imagem/capa/disco elysium - capa1.png",			75.49,		"DE desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (5,	"Elden Ring",				"FromSoftware",			"/resources/imagem/capa/elden ring - capa1.png",			274.50,		"ELR desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (6,	"Fallout: New Vegas",			"Obsidian Entertainment",	"/resources/imagem/capa/fallout new vegas - capa1.png",			39,		"FNV desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (7,	"Garry's Mod",				"Facepunch Studios",		"/resources/imagem/capa/garry's mod - capa1.png",			25.99,		"GM desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (8,	"Hollow Knight",			"Team Cherry",			"/resources/imagem/capa/hollow knight - capa1.png",			46.99,		"HLK desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (9,	"Inscryption",				"Daniel Mullins Games",		"/resources/imagem/capa/inscryption - capa1.png",			49.99,		"INC desc");
INSERT INTO jogos(Id_jogo, Nome_jogo, desenvolvedora, imagem, valor, detalhes) VALUE (10,	"Journey",				"thatgamecompany",		"/resources/imagem/capa/journey - capa1.png",				43.99,		"JRN desc");
